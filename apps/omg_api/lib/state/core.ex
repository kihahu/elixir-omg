...
defmodule OMG.API.State.Core do
  ...
  defp correct_input_in_position?(
    ...
    with :ok <- utxo_not_from_the_future_block?(state, {blknum, txindex}) do
  ...
  defp utxo_not_from_the_future_block?(%__MODULE__{height: blknum, tx_index: txindex}, {input_blknum, input_txindex}) do
